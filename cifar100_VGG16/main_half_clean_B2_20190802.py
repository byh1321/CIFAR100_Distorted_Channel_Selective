...
#
#cifar_train_blur_09 = cifar_dirty_train.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.9_train_targets.csv")
#cifar_train_blur_0675 = cifar_dirty_train.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.675_train_targets.csv")
#cifar_train_blur_045 = cifar_dirty_train.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.45_train_targets.csv")
#
#cifar_train_gaussian_008_blur_033_mixed = cifar_dirty_test.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.08_blur_0.33_train_targets.csv") 
...
#test_loader = torch.utils.data.DataLoader(cifar_test_gaussian_016,batch_size=1250, shuffle=False,num_workers=8,drop_last=False)
...
if args.mode == 0:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20190802_half_clean_B2.t0')
	ckpt = torch.load('./checkpoint/ckpt_20190802_half_clean_B1.t0')
	net = checkpoint['net']
	net2 = ckpt['net']
	if args.resume:
		print('==> Resuming from checkpoint..')
...
if args.pr:
	params = utils.paramsGet(net)
	thres = utils.findThreshold(net, params, args.pr)
...
def train(net, epoch):
	...
	mask_channel = utils.setMask(utils.setMask(mask_channel, 2, 1), 3, 0)
...
def test(net):
	...
	if acc > best_acc:
		...
		if args.mode == 0:
			...
			print('Saving..')
			torch.save(state, './checkpoint/ckpt_20190802_half_clean_B2.t0')
		best_acc = acc
