...
checkpoint = torch.load('./checkpoint/ckpt_20180609_half_clean_0.375_blur_mixed_fixed3.t0')
...
def test():
	...
	if acc > best_acc:
		...
		if not os.path.isdir('checkpoint'):
			os.mkdir('checkpoint')
		torch.save(state,'./checkpoint/ckpt_20180609_half_clean_0.375_blur_mixed_fixed3.t0')
		best_acc = acc
