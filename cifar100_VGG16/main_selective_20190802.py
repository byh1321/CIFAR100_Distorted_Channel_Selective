...
cifar_test_gaussian_025 = cifar_dirty_test.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.25_blur_0.0_test_targets.csv")
cifar_test_gaussian_016 = cifar_dirty_test.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.16_blur_0.0_test_targets.csv")
cifar_test_gaussian_008 = cifar_dirty_test.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.08_blur_0.0_test_targets.csv")

cifar_train_gaussian_025 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.25_blur_0.0_train_targets.csv")
cifar_train_gaussian_016 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.16_blur_0.0_train_targets.csv")
cifar_train_gaussian_008 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.08_blur_0.0_train_targets.csv")

cifar_test_blur_09 = cifar_dirty_test.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.9_test_targets.csv")
cifar_test_blur_0675 = cifar_dirty_test.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.675_test_targets.csv")
cifar_test_blur_045 = cifar_dirty_test.CIFAR100DIRTY_TEST("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.45_test_targets.csv")

cifar_train_blur_09 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.9_train_targets.csv")
cifar_train_blur_0675 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.675_train_targets.csv")
cifar_train_blur_045 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.0_blur_0.45_train_targets.csv")

cifar_train_gaussian_008_blur_033_mixed = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/CIFAR100_Distorted_Channel_Selective/cifar100_VGG16/cifar100_gaussian_0.08_blur_0.33_train_targets.csv") 
...
'''
#'''
check1 = torch.load('./checkpoint/ckpt_20190802_half_clean_B3.t0')
check2 = torch.load('./checkpoint/ckpt_20190802_half_clean_B2.t0')
check3 = torch.load('./checkpoint/ckpt_20190802_half_clean_B1.t0')
check4 = torch.load('./checkpoint/ckpt_20190802_half_clean.t0')
check5 = torch.load('./checkpoint/ckpt_20190802_half_clean_G1.t0')
check6 = torch.load('./checkpoint/ckpt_20190802_half_clean_G2.t0')
check7 = torch.load('./checkpoint/ckpt_20190802_half_clean_G3.t0')
#'''
...
PFSUM_blur09 = np.genfromtxt('test_B3.txt',delimiter=',')
PFSUM_blur0675 = np.genfromtxt('test_B2.txt',delimiter=',')
PFSUM_blur045 = np.genfromtxt('test_B1.txt',delimiter=',')
PFSUM_clean = np.genfromtxt('test_clean.txt',delimiter=',')
PFSUM_gau008= np.genfromtxt('test_G1.txt',delimiter=',')
PFSUM_gau016= np.genfromtxt('test_G2.txt',delimiter=',')
PFSUM_gau025= np.genfromtxt('test_G3.txt',delimiter=',')

PFDIFF_blur09 = np.genfromtxt('test2_B3.txt',delimiter=',')
PFDIFF_blur0675 = np.genfromtxt('test2_B2.txt',delimiter=',')
PFDIFF_blur045 = np.genfromtxt('test2_B1.txt',delimiter=',')
PFDIFF_clean = np.genfromtxt('test2_clean.txt',delimiter=',')

PFSUM_array = np.append(PFSUM_blur09, PFSUM_blur0675)
PFSUM_array = np.append(PFSUM_array, PFSUM_blur045)
PFSUM_array = np.append(PFSUM_array, PFSUM_clean)
PFSUM_array = np.append(PFSUM_array, PFSUM_gau008)
PFSUM_array = np.append(PFSUM_array, PFSUM_gau016)
PFSUM_array = np.append(PFSUM_array, PFSUM_gau025)

PFDIFF_array = np.append(PFDIFF_blur09, PFDIFF_blur0675)
PFDIFF_array = np.append(PFDIFF_array, PFDIFF_blur045)
PFDIFF_array = np.append(PFDIFF_array, PFDIFF_clean)
'''
f= open("result.txt",'w')
...
def test():
	...
	for batch_idx, (inputs, targets) in enumerate(test_loader):
		...
		if PFSUM_array[idx] < PFSUM_bar2:
			if PFDIFF_array[idx] < PFDIFF_bar1:
				outputs = net1(inputs)
				count_net1 +=1
			elif PFDIFF_array[idx] < PFDIFF_bar2:
				outputs = net2(inputs)
				count_net2 +=1
		elif PFSUM_array[idx] < PFSUM_bar3:
			outputs = net3(inputs)
			count_net3 +=1
		elif PFSUM_array[idx] < PFSUM_bar4:
			outputs = net4(inputs)
			count_net4 +=1
		elif PFSUM_array[idx] < PFSUM_bar5:
			outputs = net5(inputs)
			count_net5 +=1
		elif PFSUM_array[idx] < PFSUM_bar6:
			outputs = net6(inputs)
			count_net6 +=1
		else:
			outputs = net7(inputs)
