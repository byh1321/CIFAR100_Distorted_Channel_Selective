...
parser.add_argument('--print', default=1, type=int, help='print input and dirty img to png') #mode=1 is train, mode=0 is inference
...
test_loader = torch.utils.data.DataLoader(cifar_test,batch_size=1, shuffle=False,num_workers=1,drop_last=False)
