...
if args.mode == 0:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180903_prune_half_clean_016_gaussian.t0')
	ckpt = torch.load('./checkpoint/ckpt_20180903_prune_half_clean_008_gaussian_prune_80_pprec_15.t0')
	net = checkpoint['net']
	net2 = ckpt['net']
	if args.resume:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180903_prune_half_clean_016_gaussian_prune_80_pprec_15.t0')
	ckpt = torch.load('./checkpoint/ckpt_20180903_prune_half_clean_008_gaussian_prune_80_pprec_15.t0')
	net = checkpoint['net']
	net2 = ckpt['net']
	if args.resume:
