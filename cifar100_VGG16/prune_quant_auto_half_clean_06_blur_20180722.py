...
if args.mode == 0:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180722_half_clean_06_blur.t0')
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180722_half_clean_06_blur_prune_80_pprec_15.t0')
	ckpt = torch.load('./checkpoint/ckpt_20180722_half_clean_prune_80_pprec_15.t0')
	net = checkpoint['net']
	net2 = ckpt['net']
	if args.resume:
