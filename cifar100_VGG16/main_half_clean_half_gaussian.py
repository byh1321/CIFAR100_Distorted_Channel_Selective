...
if blocking == 0:
	...
	for i in range(192):
		mask_conv4[i,0:95,:,:] = 1
		mask_conv5[i,0:191,:,:] = 1
		mask_conv6[i,0:191,:,:] = 1
	for i in range(384):
		mask_conv7[i,0:191,:,:] = 1
		mask_conv8[i,0:383,:,:] = 1
		mask_conv9[i,0:383,:,:] = 1
		mask_conv10[i,0:383,:,:] = 1
		mask_conv11[i,0:383,:,:] = 1
		mask_conv12[i,0:383,:,:] = 1
		mask_fc0[i,0:383] = 1 
		mask_fc1[i,0:383] = 1 
	mask_fc2[:,0:383] = 1 
elif blocking == 3:
...
def test():
	...
	if acc > best_acc:
		...
		if not os.path.isdir('checkpoint'):
			os.mkdir('checkpoint')
		torch.save(state,'./checkpoint/ckpt_20180609_half_clean_half_gaussian.t0')
		best_acc = acc
