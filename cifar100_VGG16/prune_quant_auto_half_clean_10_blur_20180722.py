...
if args.mode == 0:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180722_half_clean_10_blur.t0')
	ckpt = torch.load('./checkpoint/ckpt_20180722_half_clean_08_blur_prune_80_pprec_15.t0')
	net = checkpoint['net']
	net2 = ckpt['net']
	if args.resume:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180722_half_clean_10_blur_prune_80_pprec_15.t0')
	ckpt = torch.load('./checkpoint/ckpt_20180722_half_clean_08_blur_prune_80_pprec_15.t0')
	net = checkpoint['net']
	net2 = ckpt['net']
	if args.resume:
