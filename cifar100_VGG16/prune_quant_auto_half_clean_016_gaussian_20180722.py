...
parser.add_argument('--network', default='ckpt_20180722_half_clean_016_gaussian.t0', help='input network ckpt name', metavar="FILE")
...
if args.mode == 0:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180722_half_clean_016_gaussian.t0')
	ckpt = torch.load('./checkpoint/ckpt_20180722_half_clean_008_gaussian_prune_80_pprec_15.t0')
	net = checkpoint['net']
	net2 = ckpt['net']
	if args.resume:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180722_half_clean_016_gaussian_prune_80_pprec_15.t0')
	ckpt = torch.load('./checkpoint/ckpt_20180722_half_clean_008_gaussian_prune_80_pprec_15.t0')
	net = checkpoint['net']
	net2 = ckpt['net']
	if args.resume:
