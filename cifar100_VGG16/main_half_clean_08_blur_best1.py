...
checkpoint = torch.load('./checkpoint/ckpt_20180609_half_clean_08_blur_best1.t0')
ckpt = torch.load('./checkpoint/ckpt_20180609_half_clean_06_blur_best1.t0')
if args.resume == 0:
	best_acc = 0
else:
...
def test():
	...
	if acc > best_acc:
		...
		if not os.path.isdir('checkpoint'):
			os.mkdir('checkpoint')
		torch.save(state,'./checkpoint/ckpt_20180609_half_clean_08_blur_best1.t0')
		best_acc = acc
