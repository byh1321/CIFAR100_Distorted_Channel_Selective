...
parser.add_argument('--trainsel', type=int, default=0, metavar='N')
...
if args.trainsel == 0:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_10, cifar_train_gaussian_008_blur_033_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
if args.trainsel == 1:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_10, cifar_train_gaussian_016_blur_06_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
if args.trainsel == 2:
...
if args.trainsel == 3:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_10, cifar_train_gaussian_025_blur_15_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)

'''
if args.trainsel == 0:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_15, cifar_train_gaussian_008_blur_033_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
if args.trainsel == 1:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_15, cifar_train_gaussian_016_blur_06_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
if args.trainsel == 2:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_15, cifar_train_gaussian_025_blur_10_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
if args.trainsel == 3:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_15, cifar_train_gaussian_025_blur_15_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
'''
'''
if args.trainsel == 4:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_gaussian_025_blur_15_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
if args.trainsel == 5:
	train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_05, cifar_train_gaussian_025_blur_15_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
'''
#train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_15, cifar_train_gaussian_016_blur_066_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
test_loader = torch.utils.data.DataLoader(cifar_test_blur_05,batch_size=10000, shuffle=False,num_workers=8,drop_last=False)
