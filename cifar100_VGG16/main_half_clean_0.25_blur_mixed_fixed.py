...
cifar_train_gaussian_025 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/180606_cifar100_VGG16/cifar100_gaussian_0.25_blur_0.0_train_targets.csv")
cifar_train_gaussian_016 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/180606_cifar100_VGG16/cifar100_gaussian_0.16_blur_0.0_train_targets.csv")
cifar_train_gaussian_008 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/180606_cifar100_VGG16/cifar100_gaussian_0.08_blur_0.0_train_targets.csv")
...
cifar_train_blur_10 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/180606_cifar100_VGG16/cifar100_gaussian_0.0_blur_1.0_train_targets.csv")
cifar_train_blur_06 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/180606_cifar100_VGG16/cifar100_gaussian_0.0_blur_0.6_train_targets.csv")
cifar_train_blur_03 = cifar_dirty_train.CIFAR100DIRTY_TRAIN("/home/yhbyun/180606_cifar100_VGG16/cifar100_gaussian_0.0_blur_0.3_train_targets.csv")
...
train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_gaussian_016, cifar_train_blur_06, cifar_train_gaussian_blur_mixed]),batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
#train_loader = torch.utils.data.DataLoader(cifar_train_blur_06,batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
...
checkpoint = torch.load('./checkpoint/ckpt_20180609_half_clean_0.25_blur_mixed_fixed.t0')
ckpt = torch.load('./checkpoint/ckpt_20180609_half_clean_0.125_blur_mixed_fixed.t0')
if args.resume == 0:
	best_acc = 0
else:
...
def test():
	...
	if acc > best_acc:
		...
		if not os.path.isdir('checkpoint'):
			os.mkdir('checkpoint')
		torch.save(state,'./checkpoint/ckpt_20180609_half_clean_0.25_blur_mixed_fixed.t0')
		best_acc = acc
