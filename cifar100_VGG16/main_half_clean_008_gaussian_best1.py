...
checkpoint = torch.load('./checkpoint/ckpt_20180620_half_clean_008_gaussian_best1.t0')
...
def test():
	...
	if acc > best_acc:
		...
		if not os.path.isdir('checkpoint'):
			os.mkdir('checkpoint')
		torch.save(state,'./checkpoint/ckpt_20180620_half_clean_008_gaussian_best1.t0')
		best_acc = acc
