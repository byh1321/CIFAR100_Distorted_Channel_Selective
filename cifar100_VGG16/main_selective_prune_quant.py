...
# Load checkpoint.
check1 = torch.load('./checkpoint/ckpt_20180903_half_clean_15_blur_prune_80_pprec_15.t0')
check2 = torch.load('./checkpoint/ckpt_20180903_half_clean_10_blur_prune_80_pprec_15.t0')
check3 = torch.load('./checkpoint/ckpt_20180903_half_clean_05_blur_prune_80_pprec_15.t0')
check4 = torch.load('./checkpoint/ckpt_20180903_half_clean_prune_80_pprec_15.t0')
check5 = torch.load('./checkpoint/ckpt_20180903_half_clean_008_gaussian_prune_80_pprec_15.t0')
check6 = torch.load('./checkpoint/ckpt_20180903_half_clean_016_gaussian_prune_80_pprec_15.t0')
check7 = torch.load('./checkpoint/ckpt_20180903_half_clean_025_gaussian_prune_80_pprec_15.t0')
