...
parser.add_argument('--block', type=int, default=3, metavar='N',help='Choose range of network blocking')
...
test_loader = torch.utils.data.DataLoader(cifar_test,batch_size=10000, shuffle=False,num_workers=3,drop_last=False)
