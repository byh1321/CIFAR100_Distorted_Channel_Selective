...
train_loader = torch.utils.data.DataLoader(torch.utils.data.ConcatDataset([cifar_train, cifar_train_blur_045, cifar_train_blur_0675, cifar_train_blur_09, cifar_train_gaussian_005, cifar_train_gaussian_010, cifar_train_gaussian_015]),batch_size=args.bs, shuffle=False,num_workers=8,drop_last=False)
#train_loader = torch.utils.data.DataLoader(cifar_train,batch_size=args.bs, shuffle=True,num_workers=8,drop_last=False)
