...
parser.add_argument('--istest', type=int, default=0, metavar='N',help='istest==0, train loader//istest==1, testloader')
...
if args.resume:
	...
	checkpoint = torch.load('./checkpoint/ckpt_20180911_full_clean.t0')
	best_acc = 0 
	net = checkpoint['net']
